...
export default function UpcomingHackathons() {
    ...
    const upcomingHackathons = hackathons && hackathons.filter((hackathon) => hackathon.status === 'upcoming');
        ...
        <section className="py-16">
            <div className="mb-10">
                ...
                <p className="max-w-3xl text-[#666666] leading-8 text-base md:text-lg">
                    Prepare for exciting upcoming hackathons organized by
                    colleges, startups, and tech communities. Explore future
                    coding competitions, collaborate with innovators, and get
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-8">
                            {
                                upcomingHackathons.length === 0 ?
                                    <span className="text-4xl text-gray-800/70 text-center w-full">NO UPCOMING HACKATHONS</span> :
